QUESTIONS = [
    ...
    },
    {
        ...
        "logical_function": "Trava de compatibilidade financeira",
        "logical_weight": "Trava forte",
        "text": "Você prevê precisar utilizar esse dinheiro no curto ou médio prazo?",
        "type": "single_choice",
        "options": [
            {
                "id": 1,
                "label": "sim, devo precisar do recurso em até 12 meses",
                "level": "trava_forte",
            },
            {
                "id": 2,
                "label": "talvez, posso precisar entre 1 e 3 anos",
                "level": "moderacao",
            },
            {
                "id": 3,
                "label": "não, não pretendo usar esse recurso no curto ou médio prazo",
                "level": "sem_trava",
            },
        ],
    },
